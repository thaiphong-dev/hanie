...
- Name: admin\admin.spec.ts >> 4.6 — Services CRUD >> danh sách services hiển thị đúng
- Location: tests\e2e\admin\admin.spec.ts:319:7
...
Locator: locator('[data-testid*="service"], [class*="service-item"], tr').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid*="service"], [class*="service-item"], tr').first()
