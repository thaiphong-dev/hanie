...
- Name: customer\booking.spec.ts >> 2.3 — Validation booking >> SĐT sai format → lỗi "Số điện thoại không hợp lệ"
- Location: tests\e2e\customer\booking.spec.ts:125:7
...
Call log:
  - waiting for getByRole('button', { name: /xác nhận đặt lịch|confirm|đặt lịch/i })
    - locator resolved to <button disabled class="flex items-center gap-2 font-body text-sm font-medium tracking-widest uppercase px-6 py-3 rounded-full transition-colors bg-bg-secondary text-text-muted cursor-not-allowed">Xác nhận đặt lịch</button>
    ...
    - main [ref=e20]:
      - generic [ref=e21]:
        - generic [ref=e24]:
          ...
          - generic [ref=e33]:
            - img [ref=e35]
            - generic [ref=e37]: Chọn ngày giờ
          - generic [ref=e40]:
            - img [ref=e42]
            - generic [ref=e44]: Chọn kỹ thuật viên
          - generic [ref=e47]:
            - generic [ref=e48]: "4"
            - generic [ref=e49]: Xác nhận
        - generic [ref=e50]:
          - generic [ref=e51]:
            - heading "Xác nhận" [level=2] [ref=e52]
            - generic [ref=e53]:
              - generic [ref=e54]:
                - img [ref=e55]
                - generic [ref=e57]:
                  - paragraph [ref=e58]: Ngày
                  - paragraph [ref=e59]: Thứ Năm, 4 tháng 6, 2026
              - generic [ref=e60]:
                - img [ref=e61]
                - generic [ref=e64]:
                  - paragraph [ref=e65]: Giờ
                  - paragraph [ref=e66]: 09:00 · ~60 phút
              - paragraph [ref=e68]: Nail tay
            - generic [ref=e69]:
              - generic [ref=e70]:
                - generic [ref=e71]: Tên của bạn
                - textbox "Nguyễn Văn A" [ref=e72]: Test User
              - generic [ref=e73]:
                - generic [ref=e74]: Số điện thoại
                - textbox "0901 234 567" [active] [ref=e75]: "12345"
                - paragraph [ref=e76]: "Số điện thoại không hợp lệ (VD: 0901234567)"
              - generic [ref=e77]:
                - generic [ref=e78]: Ghi chú thêm (tuỳ chọn)
                - textbox "Ghi chú thêm (tuỳ chọn)" [ref=e79]
          - generic [ref=e80]:
            - button "← Quay lại" [ref=e81] [cursor=pointer]
            - button "Xác nhận đặt lịch" [disabled] [ref=e82]
    - contentinfo [ref=e83]:
      - generic [ref=e84]:
        - generic [ref=e85]:
          - generic [ref=e86]:
            - img "Hanie Studio" [ref=e87]
            - paragraph [ref=e88]: Studio làm đẹp tại Quy Nhơn. Nối mi · Lông mày · Gội đầu · Nail.
          - generic [ref=e89]:
            - heading "Dịch vụ" [level=4] [ref=e90]
            - list [ref=e91]:
              - listitem [ref=e92]:
                - link "Nail" [ref=e93] [cursor=pointer]:
                  - /url: /vi/services#nail
              - listitem [ref=e94]:
                - link "Nối mi" [ref=e95] [cursor=pointer]:
                  - /url: /vi/services#lash
              - listitem [ref=e96]:
                - link "Lông mày" [ref=e97] [cursor=pointer]:
                  - /url: /vi/services#brow
              - listitem [ref=e98]:
                - link "Gội đầu" [ref=e99] [cursor=pointer]:
                  - /url: /vi/services#hair_wash
          - generic [ref=e100]:
            - heading "Thông tin" [level=4] [ref=e101]
            - list [ref=e102]:
              - listitem [ref=e103]:
                - img [ref=e104]
                - generic [ref=e107]: 09A Nguyễn Đình Thụ, Quy Nhơn Nam, Gia Lai
              - listitem [ref=e108]:
                - img [ref=e109]
                - link "0967 273 066" [ref=e111] [cursor=pointer]:
                  - /url: tel:0967273066
              - listitem [ref=e112]:
                - img [ref=e113]
                - generic [ref=e116]: 08:00 – 20:00 hàng ngày
          - generic [ref=e117]:
            - heading "Đặt lịch nhanh" [level=4] [ref=e118]
            - link "Đặt lịch ngay" [ref=e119] [cursor=pointer]:
              - /url: /vi/booking
        - paragraph [ref=e121]: © 2026 Hanie Studio. All rights reserved.
  - alert [ref=e122]
```
...
```ts
  ...
  39  | 
  40  |     // Thử native input trước
  41  |     const nativeInput = this.page.locator('input[type="date"]').first();
  42  |     const hasNative = await nativeInput.count() > 0;
  43  |     if (hasNative) {
  44  |       await nativeInput.fill(date);
  45  |       await nativeInput.press('Tab');
  46  |       await this.page.waitForTimeout(500);
  47  |       return;
  48  |     }
  49  | 
  50  |     // Custom DatePicker: click trigger button để mở calendar
  51  |     const pickerTrigger = this.page.getByPlaceholder(/chọn ngày|select date|날짜 선택/i).first()
