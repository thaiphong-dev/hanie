...
- Name: customer\booking.spec.ts >> 2.1 — Guest booking (không đăng nhập) >> đặt nail tay → thành công + POST /api/v1/bookings trả 201
- Location: tests\e2e\customer\booking.spec.ts:22:7
