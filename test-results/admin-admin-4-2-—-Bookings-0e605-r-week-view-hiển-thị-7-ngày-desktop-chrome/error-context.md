...
- Name: admin\admin.spec.ts >> 4.2 — Bookings calendar >> week view hiển thị 7 ngày
- Location: tests\e2e\admin\admin.spec.ts:63:7
...
Locator: locator('[class*="calendar"], [class*="week"], table').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="calendar"], [class*="week"], table').first()
