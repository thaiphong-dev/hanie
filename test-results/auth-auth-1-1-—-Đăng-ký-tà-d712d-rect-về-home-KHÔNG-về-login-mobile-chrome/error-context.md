...
- Name: auth\auth.spec.ts >> 1.1 — Đăng ký tài khoản mới >> register → redirect về home, KHÔNG về /login
- Location: tests\e2e\auth\auth.spec.ts:15:7
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e6]:
      - generic [ref=e8]:
        - heading "Tạo tài khoản" [level=1] [ref=e9]
        - generic [ref=e10]:
          - generic [ref=e11]:
            - generic [ref=e12]: Họ và tên
            - textbox "Họ và tên" [ref=e13]:
              - /placeholder: Nguyễn Văn A
              - text: Test Register User
          - generic [ref=e14]:
            - generic [ref=e15]: Số điện thoại
            - textbox "Số điện thoại" [ref=e16]:
          ...
          - generic [ref=e17]:
            ...
            - textbox "Mật khẩu" [ref=e19]:
              ...
              - text: password123
          - paragraph [ref=e20]: Quá nhiều lần thử. Vui lòng đợi 15 phút.
          - button "Đăng ký" [ref=e21] [cursor=pointer]
        - paragraph [ref=e22]:
          - text: Đã có tài khoản?
          - link "Đăng nhập ngay" [ref=e23] [cursor=pointer]:
            - /url: /vi/login
    - contentinfo [ref=e24]:
      - paragraph [ref=e25]: © 2026 Hanie Studio
  - alert [ref=e26]
```
