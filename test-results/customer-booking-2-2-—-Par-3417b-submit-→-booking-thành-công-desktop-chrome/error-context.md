...
- Name: customer\booking.spec.ts >> 2.2 — Parallel nail tay + nail chân >> chọn parallel → submit → booking thành công
- Location: tests\e2e\customer\booking.spec.ts:86:7
...
Call log:
  - waiting for getByText(/2 kỹ thuật viên.*cùng lúc|phục vụ cùng lúc/i)
        ...
        - generic [ref=e81]:
          ...
          - generic [ref=e96]:
            ...
            - list [ref=e98]:
              - listitem [ref=e99]:
                - img [ref=e100]
                - generic [ref=e103]: 55 Nguyễn Nhạc, Quy Nhơn, Bình Định
              - listitem [ref=e104]:
                - img [ref=e105]
