...
- Name: security\security.spec.ts >> 5.2 — SQL injection >> name: "'; DROP TABLE bookings; --" → submit thành công, tên lưu literal
- Location: tests\e2e\security\security.spec.ts:73:7
